    ...
    for i in range(len(shells_on_fly)):
        ...
        for j in range(len(balls)):
            ...
            # if (shells_on_fly[i]._x - balls[j]._x)**2+(shells_on_fly[i]._y - balls[j]._y)**2 <= (shells_on_fly[i]._R + balls[j]._R)**2:
                print('Левая часть неравенства:',(shells_on_fly[i]._x - balls[j]._x)**2+(shells_on_fly[i]._y - balls[j]._y)**2)
                print('Правая часть неравенства:',(shells_on_fly[i]._R + balls[j]._R)**2)
                print('Попали')
